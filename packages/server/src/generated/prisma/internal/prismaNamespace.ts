...
> = {
  ...
  meta: {
    modelProps: 'user' | 'session' | 'message' | 'agentRun' | 'toolCall'
...
export type ToolCallScalarFieldEnum =
  (typeof ToolCallScalarFieldEnum)[keyof typeof ToolCallScalarFieldEnum]
 ...
 * Reference to a field of type 'ToolCallStatus[]'
 */
export type ListEnumToolCallStatusFieldRefInput<$PrismaModel> = FieldRefInputType<
  $PrismaModel,
  'ToolCallStatus[]'
>
